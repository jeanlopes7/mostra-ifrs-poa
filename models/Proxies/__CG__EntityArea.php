 ...
 */
class Area extends \Entity\Area implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getIdArea()
    {
        if ($this->__isInitialized__ === false) {
            return (int) $this->_identifier["idArea"];
        }
        $this->__load();
    ...
    {
        return array('__isInitialized__', 'nome', 'idArea', 'avaliadorArea');
    }
