...
<form action="<?=base_url()?>usuario/avaliador_ctr/fazer_inscricao" method="post" class="form-horizontal" role="form">
...
<div class="form-group">
    <label for="input_formacao" class="col-sm-2 control-label">Formação</label>
        <div class="col-sm-5">
            <select name="formacao" id="input_formacao" class="form-control" required>
...
<div class="form-group">
        ...
        <div class="col-sm-5">
            <select name="area_tematica" id="input_area_tematica" class="form-control" required="required">
                <option value="">Selecione um item da lista</option>
