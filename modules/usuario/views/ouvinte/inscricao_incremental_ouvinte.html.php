...
<form action="<?=base_url()?>usuario/ouvinte_ctr/inscricao_incremental" method="post" class="form-horizontal" role="form">

<div class="form-group">
    <label for="input_formacao" class="col-sm-2 control-label">Tipo de ouvinte</label>
        <div class="col-sm-5">
            <select name="tipo_ouvinte" id="input_tipo_ouvinte" class="form-control" required="required" autofocus>
...
<div class="form-group">
	<label for="input" class="col-sm-2 control-label">Empresa</label>
	<div class="col-sm-5">
...
<div class="form-group">
	<label for="input" class="col-sm-2 control-label">Outro</label>
	<div class="col-sm-5">
