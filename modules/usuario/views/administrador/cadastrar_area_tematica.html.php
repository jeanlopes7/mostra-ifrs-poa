...
<?=set_breadcrumb()?>
<form id="cadastrarAreaTematicaForm" method="post" class="form-search" autocomplete="off">
    ...
    <div class="form-group text-right">
        <div class="col-sm-offset-2 col-sm-10">
            <button type="submit" class="btn btn-primary" form="cadastrarAreaTematicaForm">
              Cadastrar
            </button>
        </div>
    </div>
